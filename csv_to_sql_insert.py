#Task is to insert data into already existing table from a csv file
#The table consists of 5 columns
#Its our job to insert the values from csv file to sql DB one by one using iteration

import mysql.connector 
f=open('influencer_details','r')
